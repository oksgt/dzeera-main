                    ...
                    <div class="container-fliud">
                        <div class="wrapper row">
                                ...
                                <div class="preview-pic tab-content">
                                    @if (!empty($images))
                                        @foreach ($images as $item)
                                            ...
                                            @endphp
                                            <div class="tab-pane {{ $item->is_thumbnail == 1 ? 'active' : '' }}"
                                                id="pic-{{ $item->id }}"><img src="{!! imageDir() . $image !!}" /></div>
                                        @endforeach
                                    ...
                                    @else
                                        <div class="tab-panel text-center" id="pic-1"><img class="w-25"
                                                src="{!! imageDir() . 'images/no-image.png' !!}" /></div>
                                    @endif
                                </div>
                            ...
                            <div class="details col-md-6">
                                <h6><span
                                        class="badge bg-{{ $product_detail->product_status == 'ready' ? 'warning' : 'secondary' }}">{{ strtoupper($product_detail->product_status) }}</span>
                                </h6>
                                <h3 class="product-title" style="font-weight: normal !important">
                                    {{ $product_detail->product_name }} - {{ $product_detail->color_name }}</h3>
                                <div class="rating">
                                    <div class="stars">
                                        @php
                                                        ...
                                                        <form action="{{ url('/cart') }}" method="POST">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" class="form-control"
                                                                    ...
                                                                    value="{{ $initStock }}" name="qty"
                                                                    {{ !$editQty ? 'disabled' : '' }}>
                                                                <button type="submit"
                                                                    class="btn btn-outline-dark btn-sm float-end w-50"
                                                                    {{ !$buy ? 'disabled' : '' }}>{{ __('general.buy') }}</button>
                                                            </div>
                                ...
                                <div class="product-description-container mt-4">
                                    ...
                                    <p>
                                        <a id="seeMoreLink"
                                            style="text-decoration: none !mportant; cursor: pointer; color: #e30c83">See
                                            More</a>
                                    </p>
                                </div>
